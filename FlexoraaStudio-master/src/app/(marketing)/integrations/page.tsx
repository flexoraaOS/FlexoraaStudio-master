...
const jsonLd = {
   ...
   "url": "https://www.flexoraaa.com/integrations/",
   "featureList": [
  ...
  return (
    <div className="bg-background overflow-x-hidden">
      ...
      <section className="py-20 md:py-28 relative">
          <div className="absolute inset-0 bg-grid-pattern [mask-image:radial-gradient(ellipse_at_center,white_20%,transparent_80%)] opacity-30"></div>
          <div className="container text-center relative z-10">
            <h1 className="text-4xl md:text-6xl font-bold font-headline tracking-tighter">
              The Execution OS That <span className="gradient-text">Connects Everything</span>
            </h1>
            <p className="mt-4 max-w-3xl mx-auto text-lg md:text-xl text-muted-foreground">
              Flexoraa Intelligence OS unifies WhatsApp, Instagram, Gmail, CRMs, and your favorite business tools into one window — so you work 70% faster with zero human error.
            </p>
          </div>
      </section>
             ...
             <div key={category.title} className="container mx-auto px-4">
                <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
                    <div className={cn("relative w-full flex items-center justify-center min-h-[350px] md:min-h-[400px]", catIndex % 2 === 1 && "md:order-2")}>
                         <HubSpokeDiagram items={category.integrations} />
                    </div>
                        ...
                        <div className="space-y-4">
                            {category.integrations.map(integration => (
                                <div key={integration.name} className="flex items-start gap-3">
                                    <div className="p-2 bg-secondary rounded-md">{React.cloneElement(integration.icon, {className: "h-5 w-5"})}</div>
                                    <div>
      ...
      {/* Coming Soon Section */}
        <section className="py-16 md:py-24 bg-black">
            <div className="container max-w-5xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-bold font-headline">The Execution OS is expanding.</h2>
      ...
      <section className="py-20 md:py-28 relative overflow-hidden bg-background">
          <div className="absolute inset-0 aurora-background [mask-image:radial-gradient(ellipse_at_center,white_20%,transparent_70%)]"></div>
          <div className="container relative z-10">
            <div className="glass-card max-w-4xl mx-auto text-center">
                <div className="space-y-4">
                    <h2 className="text-3xl font-bold font-headline text-foreground">Automate 70% of Your Workflow</h2>
                    <p className="text-muted-foreground max-w-2xl mx-auto">
                      Flexoraa gives your business the power of automated productivity, slashing costs and letting your team focus on the 30% of high-impact work that truly matters.
                    </p>
                    <div className="pt-2">
                        <Button size="lg" className="gradient-background text-primary-foreground" asChild>
                            <Link href="/login">Run on Flexoraa <ArrowRight className="ml-2 h-5 w-5" /></Link>
                        </Button>
                    </div>
                </div>
            </div>
